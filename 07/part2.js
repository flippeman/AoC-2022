...
var neededSpace = 30000000 - (70000000 - allDirectories[0].size);

var bestDeletion = 70000000;

allDirectories.forEach(directory =>  {
    if (directory.size > neededSpace && directory.size < bestDeletion) {
        bestDeletion = directory.size;
        console.log("ny bäst " + bestDeletion);
    }
})
